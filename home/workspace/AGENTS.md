...
- At or above 85% of the weekly ChatGPT allowance, start no self-directed work: scout proposes nothing and route moves no `wild-work` card to `ready`. Zach's requests keep the end of the week.
