Scout pass, once a day. You are looking for one piece of self-directed work worth proposing — not starting it.

Skip entirely and stop if any of Zach's requested cards are waiting in `triage`, `ready`, or `running`. His work comes first, and a proposal that competes with it is noise.
